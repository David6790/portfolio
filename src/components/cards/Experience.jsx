...
const Experience = () => {
  return (
    <div className=" flex flex-row justify-evenly items-center h-full w-6/12 rounded-3xl shadow-myshadow bg-card-gradiant bg-card  border-solid border-[#444] border-[1px] py-5 ">
